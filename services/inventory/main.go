...
import (
	...
	"github.com/rafidoth/train-ticket-booking-microservice/inventory/db"
	"github.com/rafidoth/train-ticket-booking-microservice/inventory/handlers"
	"github.com/rafidoth/train-ticket-booking-microservice/inventory/tracing"
)
...
func main() {
	slog.Info("Inventory Service Starting", "level", slog.LevelDebug)
	...
	shutdownTracer, err := tracing.InitTracing("inventory-service")
	if err != nil {
